...
A lot of accounting software don't work in the cloud and you might not want to use webservices or API for sensitive data. 
...
= Expert version available if you need more =
...
Not yet, but we are working on it on the Expert version.
